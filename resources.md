...
| [dataflowr-notebooks](https://github.com/LessUp/dataflowr-notebooks) | [深度分析](https://github.com/LessUp/github-repos-hub/blob/main/deep-dives/dataflowr-notebooks.md) | ⭐⭐ | 按需 |
...
### 完整索引
👉 [github-repos-hub](https://github.com/LessUp/github-repos-hub) — 所有仓库的分类索引与深度分析

## 推荐外部资源

### 论文（必读）
1. "FlashAttention: Fast and Memory-Efficient Exact Attention" (NeurIPS 2022)
2. "FlashAttention-2: Faster Attention with Better Parallelism" (2023)
3. "FlashAttention-3: Fast and Accurate Attention with Asynchrony and Low-precision" (2024)
4. "Efficient Memory Management for Large Language Model Serving with PagedAttention" (SOSP 2023)
5. "SGLang: Efficiently Programming Large Language Models" (2024)

### 博客与教程
- [CUDA C++ Programming Guide](https://docs.nvidia.com/cuda/cuda-c-programming-guide/)
- [Triton Language Documentation](https://triton-lang.org/)
- [TVM Documentation](https://tvm.apache.org/docs/)
- [Simon Boehm's CUDA GEMM](https://siboehm.com/articles/22/CUDA-MMM)
- [Lei Mao's CUDA Notes](https://leimao.github.io/)

### 视频课程
- [GPU Mode 讲座系列](https://github.com/gpu-mode/lectures)
